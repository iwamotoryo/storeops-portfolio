...
- **教室機能（クローズドベータ）**：組織・教室・講師・受講生、招待制の参加、講師向けの集計
...
| 入力検証 | Zod |
| テスト | Vitest・Testing Library・fake-indexeddb（ユニットテスト 103 ファイル）、Playwright（E2E） |
...
- 個人利用版：動作中
- 教室向け機能：コードは実装済み。一般公開の前に、クラウドへ直接保存する受験機能とメール送信の接続が残っている
...
- 公開デモを作る場合は、ローカル版とデモ模試（架空データ）だけで構成し、クラウド機能と受講生データは含めない
